...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_COMMAND:
    {
        ...
        case ID_32771:
            ...
            Illia.StartPointEditor(hWnd); //початок вводу точкових об’єктів
            break;

        case ID_TOOL_LINE:
        case ID_32772:
            myToolBar.OnTool(hWnd, ID_TOOL_LINE);
            Illia.StartLineEditor(hWnd); //початок вводу об’єктів-ліній
            break;

        case ID_TOOL_RECT:
        case ID_32773:
            myToolBar.OnTool(hWnd, ID_TOOL_RECT);
            Illia.StartRectEditor(hWnd); //початок вводу прямокутників
            break;

        case ID_TOOL_ELLIPSE:
        case ID_32774:
            myToolBar.OnTool(hWnd, ID_TOOL_ELLIPSE);
            Illia.StartEllipseEditor(hWnd); //початок вводу еліпсів
            break;
